<template>
  <div
    class="@container relative flex flex-col justify-center overflow-hidden rounded-2xl border border-white/10 lg:aspect-square @2xl:aspect-10/7 @4xl:aspect-video @5xl:aspect-12/6"
  >
    <Pattern />
